...
<head>
  ...
  <meta name="keywords" content="Webdesign Wien, Webdesigner Wien, Webdesign Agentur Wien, Webdesign Firmen Wien, Webentwicklung Wien, SEO Wien, WebDesign Alcor, Datenschutz Webdesign Wien, Datenschutzrichtlinien Webdesign Wien">
  <meta name="author" content="WebDesign Alcor">
  <meta name="page-topic" content="Datenschutz">
  <meta name="page-type" content="Datenschutzrichtlinien">
  ...
  <meta name="twitter:description" content="Erfahren Sie mehr über die Datenschutzrichtlinien von WebDesign Alcor. Ihre Privatsphäre ist uns wichtig. Informieren Sie sich über unsere Maßnahmen zum Schutz Ihrer Daten.">
  <meta name="twitter:title" content="Datenschutz - WebDesign Alcor | Webdesign und SEO in Wien">
  <meta name="twitter:image" content="https://www.webdesign-alcor.at/assets/img/datenschutz-twitter.jpg">
...
<body>
  ...
  <header class="bg-dark text-light py-5 text-center">
    <div class="container">
      <h1>Datenschutz bei Webdesign Alcor </h1>
    </div>
  </header>
    ...
    <article class="py-5 my-5">
      <div class="container">
        <section class="sec-small">
          <h2 class="fs-3 fw-bold">1. Datenschutz auf einen Blick</h2>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Allgemeine Hinweise</h3>
            <p>
              Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können. Ausführliche Informationen zum Thema Datenschutz entnehmen Sie unserer unter diesem Text aufgeführten Datenschutzerklärung.
            </p>
          </div>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Datenerfassung auf dieser Website</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Wofür nutzen wir Ihre Daten?</h3>
            <p>
              Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.
            </p>
          </div>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Welche Rechte haben Sie bezüglich Ihrer Daten?</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Analyse-Tools und Tools von Drittanbietern</h3>
            <p>
        ...
        <section class="sec-small">
          <h2 class="fs-3 fw-bold">2. Hosting</h2>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Externes Hosting</h3>
            <p>
            ...
            <h4 class="fs-6 fw-bold">Wir setzen folgende(n) Hoster ein:</h4>
            <p>
              Firma: easyname GmbH <br>
              Adresse: Canettistraße 5/10, A-1100 Wien
            </p>
            <h3 class="fs-5 fw-bold">Auftragsverarbeitung</h3>
            <p>
        ...
        <section class="sec-small">
          <h2 class="fs-3 fw-bold">3. Allgemeine Hinweise und Pflicht­informationen Datenschutz</h2>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Datenschutz</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Hinweis zur verantwortlichen Stelle</h3>
            <p>
              <b>Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</b>
            </p>
            <p>
              Robert C. Alchimowicz <br>
              WebDesign-Alcor Werbeagentur<br>
              Johann-Teufel-Gasse 39-47<br>
              1230 Wien<br>
              Telefon: +4366499124999<br>
              E-Mail: office(a)webdesign-alcor.at
            </p>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Speicherdauer</h3>
            <p>
              Soweit innerhalb dieser Datenschutzerklärung keine speziellere Speicherdauer genannt wurde, verbleiben Ihre personenbezogenen Daten bei uns, bis der Zweck für die Datenverarbeitung entfällt. Wenn Sie ein berechtigtes Löschersuchen geltend machen oder eine Einwilligung zur Datenverarbeitung widerrufen, werden Ihre Daten gelöscht, sofern wir keine anderen rechtlich zulässigen Gründe für die Speicherung Ihrer personenbezogenen Daten haben (z. B. steuer- oder handelsrechtliche Aufbewahrungsfristen); im letztgenannten Fall erfolgt die Löschung nach Fortfall dieser Gründe.
            </p>
          </div>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Hinweis zur Datenweitergabe in die USA und sonstige Drittstaaten</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
            <p>
              Viele Datenverarbeitungsvorgänge sind nur mit Ihrer ausdrücklichen Einwilligung möglich. Sie können eine bereits erteilte Einwilligung jederzeit widerrufen. Die Rechtmäßigkeit der bis zum Widerruf erfolgten Datenverarbeitung bleibt vom Widerruf unberührt.
            </p>
          </div>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Beschwerde­recht bei der zuständigen Aufsichts­behörde</h3>
            <p>
              Im Falle von Verstößen gegen die DSGVO steht den Betroffenen ein Beschwerderecht bei einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat ihres gewöhnlichen Aufenthalts, ihres Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes zu. Das Beschwerderecht besteht unbeschadet anderweitiger verwaltungsrechtlicher oder gerichtlicher Rechtsbehelfe.
            </p>
          </div>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Recht auf Daten­übertrag­barkeit</h3>
            <p>
              Sie haben das Recht, Daten, die wir auf Grundlage Ihrer Einwilligung oder in Erfüllung eines Vertrags automatisiert verarbeiten, an sich oder an einen Dritten in einem gängigen, maschinenlesbaren Format aushändigen zu lassen. Sofern Sie die direkte Übertragung der Daten an einen anderen Verantwortlichen verlangen, erfolgt dies nur, soweit es technisch machbar ist.
            </p>
          </div>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Auskunft, Berichtigung und Löschung</h3>
            <p>
              Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung und ggf. ein Recht auf Berichtigung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit an uns wenden.
            </p>
          </div>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Recht auf Einschränkung der Verarbeitung</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">SSL- bzw. TLS-Verschlüsselung</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Verschlüsselter Zahlungsverkehr auf dieser Website</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Widerspruch gegen Werbe-E-Mails</h3>
            <p>
        ...
        <section class="sec-small">
          <h2 class="fs-3 fw-bold">4. Datenerfassung auf dieser Website</h2>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Cookies</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Einwilligung mit Cookie Notice & Compliance</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Server-Log-Dateien</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Kontaktformular</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Anfrage per E-Mail, Telefon oder Telefax</h3>
            <p>
        ...
        <section class="sec-small">
          <h2 class="fs-3 fw-bold">5. Soziale Medien</h2>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Facebook</h3>
            <p>
            ...
            <p>
              Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gestützt. Details finden Sie hier: https://www.facebook.com/legal/EU_data_transfer_addendum, https://de-de.facebook.com/help/566994660333381.
            </p>
          </div>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Instagram</h3>
            <p>
        ...
        <section class="sec-small">
          <h2 class="fs-3 fw-bold">6. Analyse-Tools und Werbung</h2>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Google Tag Manager</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Google Analytics</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Browser Plugin</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Google-Signale</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Verarbeitung Google Analytics</h3>
            <p>
          ...
          <div class="content-block">
            <h3 class="fs-5 fw-bold">IP-Anonymisierung</h3>
            <p>
              Wir verwenden Analytics mit anonymisierter IP. Ihre IP-Adresse wird dabei gekürzt, sodass diese Ihnen nicht mehr direkt zugeordnet werden kann.
            </p>
          </div>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Google Ads</h3>
            <p>
        ...
        <section class="sec-small">
          <h2 class="fs-3 fw-bold">7. Plugins und Tools</h2>
          <div class="content-block">
            <h3 class="fs-5 fw-bold">Google Fonts (lokales Hosting)</h3>
            <p>
