...
<head>
  ...
  <meta name="keywords" content="Webdesign Wien, Webdesigner Wien, Webdesign Agentur Wien, Webdesign Firmen Wien, Webentwicklung Wien, SEO Wien, WebDesign Alcor, Impressum Webdesign Wien, Kontakt Webdesign Wien">
  <meta name="author" content="WebDesign Alcor">
  <meta name="page-topic" content="Impressum">
  <meta name="page-type" content="Impressum">
  ...
  <meta name="twitter:description" content="Impressum von WebDesign Alcor. Erfahren Sie mehr über unsere professionellen Webdesign- und SEO-Dienstleistungen in Wien und Umgebung. Kontaktieren Sie uns für maßgeschneiderte Lösungen.">
  <meta name="twitter:title" content="Impressum - WebDesign Alcor | Webdesign und SEO in Wien">
...
<body>
  ...
  <section class="bg-dark d-flex align-items-center">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h1 class="text-light">IMPRESSUM von Webdesign Alcor in Wien</h1>
        </div>
      </div>
  </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>
              <b>Webseitenbetreiber</b>: WEBDESIGN ALCOR <br>
              <b>Inhaber</b>: Robert Alchimowicz <br>
              <b>Branche</b>: Werbeagentur | Webdesign | SEO
            </p>

            <p>
              <b>Anschrift</b>: <br>
              Johann-Teufel-Gasse 39-47/11 <br>
              1230 Wien
            </p>

            <p>
              <b>Steuer-Nr</b>: 09 176/7798
            </p>
            ...
            <p>
              <b>Telefon</b>: +4366499124999 <br>
              <b>Email</b>: office (a) webdesign-alcor.at <br>
              <b>webseite</b>: https://www.webdesign-alcor.at
            </p>

            <p>
              <b>Anwendbare Rechtsvorschrift</b>: <br>
              www.ris.bka.gv.at
            </p>
